                        ...
                        <div className="contact-info p-lg-30 p-xs-15 bg-gray-fa bg1-gray-2">
                            <div className="content">
                                ...
                                <ul className="list-default">
                                    <li><i className="fa fa-clock-o"></i>Ntinda, Kampala Uganda</li>
                                    <li><i className="fa fa-phone"></i>+256705099093</li>
                                    <li><i className="fa fa-envelope-o"></i>magalareuben2022@gmail.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
